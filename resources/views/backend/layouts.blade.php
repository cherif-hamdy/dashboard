...
<head>
    ...
    <link href="{{ asset('backend/assets/css/nucleo-svg.css" rel="stylesheet') }}" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('backend//assets/css/soft-ui-dashboard.css?v=1.0.2') }}" rel="stylesheet" />
</head>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#">
            <img src="{{ asset('backend/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="...">
...
<script src="{{ asset('backend/assets/js/plugins/Chart.extension.js') }}"></script>
<script>
...
<script src="{{ asset('backend/assets/js/soft-ui-dashboard.min.js?v=1.0.2') }}"></script>
</body>
